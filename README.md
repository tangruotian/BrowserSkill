...
- **Explicitly control the current tab**: `bsk session start --attach-current-tab`
  ...
  tab; the original tab and window are preserved. This mode is for local
  connections; remote tasks use an Agent Window and explicit `tab borrow` authorization.
